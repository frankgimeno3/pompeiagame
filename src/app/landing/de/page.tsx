  ...
  useEffect(() => {
    switch (componenteactual) {
      case "conflicto":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/p1.png")`);
        }, 600);
        break;
      case "relaciones":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/2.png")`);
        }, 600);
        break;
      case "estrategia":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/3.png")`);
        }, 600);
        break;
      case "resolutividad":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/4.png")`);
        }, 600);
        break;
      case "trabajo":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/5.png")`);
        }, 600);
        break;
      case "lugar":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/6.png")`);
        }, 600);
        break;
      case "humor":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/7.png")`);
        }, 600);
        break;
      case "creatividad":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/8.png")`);
        }, 600);
        break;
      case "juicio":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/9.png")`);
        }, 600);
        break;
      case "horario":
        setFondo(`url("/f2.png")`);
        setTimeout(() => {
          setFondo(`url("/preguntas/de/910.png")`);
        }, 600);
        break;
      case "resultado":

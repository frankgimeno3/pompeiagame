...
const LandingContent: FC<LandingContentProps> = ({ lang, setLang }) => {
  ...
  return (
    <div>
            <p className="pt-24 mt-24 text-2xl text-black ">{Content.dashboard.tegustariasaber[lang]}</p>
      ...
      <p className="text-2xl text-black">{Content.dashboard.unaaventuraquenosensena[lang]}</p>
      ...
      <div className="flex justify-center items-center mt-10 mb-10">
        <div className="flex flex-col text-black mx-5 justify-center text-center ">
          ...
          <button className="text-2xl text-center " onClick={()=> changeLang("en")}>EN</button>
        </div>
        <div className="flex flex-col text-black  mx-5 justify-center text-center ">
          <div className="rounded-full overflow-hidden">
            <Image src="/icon/flor.png" alt="flor" width={50} height={50} />
          </div>
          <button className="text-2xl text-center " onClick={()=> changeLang("es")}>ES</button>
        </div>
        <div className="flex flex-col text-black  mx-5 justify-center text-center ">
          <div className="rounded-full overflow-hidden">
            <Image src="/icon/flor.png" alt="flor" width={50} height={50} />
          </div>
          <button className="text-2xl text-center " onClick={()=> changeLang("de")}>DE</button>
        </div>
      </div>
    </div>
  );

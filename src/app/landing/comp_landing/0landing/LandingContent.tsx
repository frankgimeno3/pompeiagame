...
const LandingContent: FC<LandingContentProps> = ({ lang, setLang }) => {
  ...
  return (
    <div>
            ...
            <h1 className="pt-6 text-6xl mx-20">{Content.dashboard.quediosdelolimpo[lang]}</h1>
      <h1 className="pt-4 text-6xl mb-5 mx-20">{Content.dashboard.terepresenta[lang]}</h1>
